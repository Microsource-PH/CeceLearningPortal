...
const Profile = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      // Fetch certificates
      const certificatesResponse = await userService.getUserCertificates(mappedUserId);
      if (certificatesResponse.data) {
        setCertificates(certificatesResponse.data);
      }

      // Fetch activity history
      const activityResponse = await userService.getActivityHistory(mappedUserId);
      ...
      if (user.role === 'Learner') {
        ...
        const instructorStatsResponse = await userService.getInstructorStats(mappedUserId);
  ...
  const tabs = [
    ...
    ...(user?.role === 'Learner' ? [{ id: "certificates", label: "Certificates", icon: Award }] : []),
    ...(user?.role === 'Creator' ? [
      { id: "teaching", label: "Teaching", icon: Briefcase },
      { id: "analytics", label: "Analytics", icon: BarChart3 },
      { id: "earnings", label: "Earnings", icon: DollarSign }
    ] : []),
    ...(user?.role === 'Admin' ? [{ id: "administration", label: "Administration", icon: Shield }] : []),
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div className="relative">
                <img 
                  src={userProfile.avatar || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face&auto=format"}
              ...
              <div>
                {isEditing ? (
                  ...
                  <h1 className="text-3xl font-bold mb-2">{userProfile.fullName}</h1>
                )}
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Badge variant={user?.role === 'Admin' ? 'destructive' : user?.role === 'Creator' ? 'secondary' : 'default'}>
                    {user?.role}
                  </Badge>
                </div>
        ...
        {/* Tab Content */}
        {activeTab === "overview" && user?.role === 'Learner' && studentStats && (
          <div className="space-y-8">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-blue">{studentStats.totalCourses}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-success">{studentStats.completedCourses}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-warning">{studentStats.learningHours}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary">{studentStats.averageScore}%</p>
                    </div>
            ...
            {subscription ? (
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-lg">
                          {subscription.planId === 'premium' ? 'Premium Plan' : 
                           subscription.planId === 'basic' ? 'Basic Plan' : 
                           subscription.planId === 'annual' ? 'Annual Premium' : 'Subscription'}
                        </h3>
                        <p className="text-sm text-muted-foreground">
                          {subscription.planId === 'basic' ? 'Access to 100+ courses' : 'Unlimited access to all courses'}
                        </p>
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-bold text-primary">
                          ...
                          <span className="text-sm font-normal text-muted-foreground">
                            /{subscription.planId === 'annual' ? 'year' : 'month'}
                          </span>
                        </p>
                      </div>
                    </div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Get unlimited access to all courses</p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {enrolledCourses.map((course) => (
                      <div key={course.id} className="flex items-center gap-4 p-3 bg-secondary/50 rounded-lg">
                        <img 
              ...
              <Card className="bg-gradient-card shadow-card">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">Total Courses</p>
                      <p className="text-2xl font-bold text-learning-blue">{userStats.totalCourses}</p>
                    </div>
                    <BookOpen className="w-8 h-8 text-learning-blue/60" />
                  </div>
                </CardContent>
              ...
              <Card className="bg-gradient-card shadow-card">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">Completed</p>
                      <p className="text-2xl font-bold text-learning-success">{userStats.completedCourses}</p>
                    </div>
                    <Award className="w-8 h-8 text-learning-success/60" />
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-warning">{userStats.totalHours}</p>
                    </div>
                    <Clock className="w-8 h-8 text-learning-warning/60" />
                  </div>
                </CardContent>
              ...
              <Card className="bg-gradient-card shadow-card">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">Avg Score</p>
                      <p className="text-2xl font-bold text-primary">{userStats.averageScore}%</p>
                    </div>
                    <Star className="w-8 h-8 text-primary/60" />
                  </div>
                </CardContent>
        ...
        {activeTab === "certificates" && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certificates.map((cert) => (
              <Card key={cert.id} className="hover:shadow-card-hover transition-all">
                <CardHeader>
        ...
        {activeTab === "teaching" && user?.role === 'Creator' && instructorStats && (
          <div className="space-y-8">
            {/* Instructor Stats */}
            <div className="grid md:grid-cols-4 gap-6">
              <Card className="bg-gradient-card shadow-card">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-blue">{instructorStats.totalStudents.toLocaleString()}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-success">{instructorStats.activeCourses}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-warning">{formatPHP(instructorStats.totalRevenue)}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary">{instructorStats.averageRating}</p>
                    </div>
                    <Star className="w-8 h-8 text-primary/60" />
                  </div>
                </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your instructor metrics and achievements</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Course Completion Rate</span>
                    <span className="font-medium">{instructorStats.completionRate}%</span>
                  </div>
                  <Progress value={instructorStats.completionRate} className="h-2" />
                  
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-sm">Student Satisfaction</span>
                    <span className="font-medium">{instructorStats.studentSatisfaction}%</span>
                  </div>
                  <Progress value={instructorStats.studentSatisfaction} className="h-2" />
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        {activeTab === "administration" && user?.role === 'Admin' && adminStats && (
          <div className="space-y-8">
            {/* Admin Stats */}
            <div className="grid md:grid-cols-4 gap-6">
              <Card className="bg-gradient-card shadow-card">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-blue">{adminStats.totalUsers.toLocaleString()}</p>
                      <p className="text-xs text-muted-foreground mt-1">+{adminStats.newUsersToday} today</p>
                    </div>
                    <Users className="w-8 h-8 text-learning-blue/60" />
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-success">{adminStats.activeCourses}</p>
                      <p className="text-xs text-muted-foreground mt-1">{adminStats.coursesUnderReview} under review</p>
                    </div>
                    <BookOpen className="w-8 h-8 text-learning-success/60" />
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-learning-warning">{formatPHP(adminStats.platformRevenue)}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary">{adminStats.supportTickets}</p>
                      <p className="text-xs text-muted-foreground mt-1">{adminStats.openTickets} open</p>
                    </div>
