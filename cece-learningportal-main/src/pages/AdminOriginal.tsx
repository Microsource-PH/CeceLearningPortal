...
const Admin: React.FC = () => {
  ...
  const fetchAdminData = async () => {
    try {
      ...
      const metricsResponse = await adminService.getAdminMetrics(selectedPeriod);
    ...
    try {
      ...
      if (response.success) {
        toast({
          ...
          description: "Course has been approved and is now active.",
        });
      ...
      <div className="min-h-screen bg-gradient-subtle">
        ...
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">Unable to fetch admin data.</p>
        ...
        <div className="w-72 bg-gradient-to-b from-blue-900 via-blue-800 to-purple-900 text-white min-h-screen p-6 shadow-2xl">
          ...
          <div className="mt-8 p-4 bg-white/10 rounded-xl border border-white/20">
            <div className="text-center">
              ...
              <Button variant="ghost" size="sm" className="mt-2 text-xs text-cyan-300 hover:text-white">
                Export Reports
              </Button>
            </div>
          </div>
            ...
            <TabsContent value="dashboard">
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">Manage your learning platform efficiently</p>
                </div>
              ...
              <div className="grid grid-cols-4 gap-6 mb-8">
                ...
                <Card className="shadow-elegant hover:shadow-glow transition-all duration-300 bg-gradient-to-br from-green-50 to-white border-green-200/50">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground">New Trainings</p>
                  </CardContent>
                </Card>
                ...
                <Card className="shadow-elegant hover:shadow-glow transition-all duration-300 bg-gradient-to-br from-orange-50 to-white border-orange-200/50">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground">Hours per User</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="shadow-elegant bg-white/80 backdrop-blur-sm border-white/50">
                <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-blue-50 to-purple-50">
                  <CardTitle className="text-2xl font-bold text-gray-800">🌟 Top Mentors</CardTitle>
                  <Button variant="outline" className="flex items-center gap-2 bg-white/70">
                    {selectedYear}
                    <ChevronDown className="w-4 h-4" />
                  </Button>
                </CardHeader>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b-2 border-gray-200">
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">Mentor</th>
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">Specialization</th>
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">Trainings</th>
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">People Trained</th>
                          <th className="text-left py-4 px-4 font-semibold text-gray-700">Rating</th>
                        </tr>
                      </thead>
                      <tbody>
                        {topMentors.map((mentor) => (
                          <tr key={mentor.id} className="border-b border-gray-100 hover:bg-gradient-to-r hover:from-blue-25 hover:to-purple-25 transition-all duration-200">
                            ...
                            <td className="py-5 px-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-gray-800">{formatRating(mentor.rating)}</span>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <span className="text-xs text-gray-500">{completion.completionDate}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            {completion.badgeIssued ? (
                              ...
                              <Dialog>
                                ...
                                <DialogContent>
                                  <DialogHeader>
                                    <DialogTitle>Issue Certification Badge</DialogTitle>
                                  </DialogHeader>
                                  <div className="space-y-6 p-4">
                                    <div className="text-center">
                                      <CertificationBadge />
                                      <h3 className="font-bold text-lg mt-3">{completion.studentName}</h3>
                                      <p className="text-muted-foreground">{completion.courseName}</p>
                                    ...
                                    <div className="space-y-3">
                                      <div className="p-4 bg-blue-50 rounded-lg">
                                        <h4 className="font-semibold text-blue-800">Certification Details</h4>
                                        <p className="text-sm text-blue-600 mt-1">
                                          This badge certifies that {completion.studentName} has successfully completed 
                                          {completion.courseName} with a score of {formatPercentage(completion.score)}.
                                        </p>
                                      </div>
                                      
                                      <Button 
                                        className="w-full bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700"
                                        onClick={() => issueBadge(completion.id)}
                                      >
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage learning policies and guidelines</p>
                  </div>
                  <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700">
                    <Plus className="w-4 h-4 mr-2" />
                    Add New Policy
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="shadow-elegant">
                    ...
                    <CardContent className="space-y-3">
                      {[
                        { name: "Course Completion Requirements", status: "Active", updated: "2 days ago" },
                        { name: "Assessment Guidelines", status: "Active", updated: "1 week ago" },
                        { name: "Certificate Standards", status: "Draft", updated: "3 days ago" }
                      ].map((policy, index) => (
                  ...
                  <Card className="shadow-elegant">
                    ...
                    <CardContent className="space-y-3">
                      {[
                        { name: "Data Privacy Policy", compliance: "100%", priority: "High" },
                        { name: "User Safety Guidelines", compliance: "95%", priority: "High" },
                        { name: "Content Moderation", compliance: "88%", priority: "Medium" }
                      ].map((rule, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            <p className="font-medium">{rule.name}</p>
                            <p className="text-sm text-muted-foreground">Compliance: {rule.compliance}</p>
                          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage administrative tasks and assignments</p>
                  </div>
                  <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700">
                    <Plus className="w-4 h-4 mr-2" />
                    Create Task
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                  <Card className="shadow-elegant">
                    <CardHeader className="bg-yellow-50">
                      <CardTitle className="text-yellow-800">Pending Tasks</CardTitle>
                    </CardHeader>
                    <CardContent className="p-4 space-y-3">
                      {[
                        { task: "Review new course submissions", due: "Today", priority: "High" },
                        { task: "Update user permissions", due: "Tomorrow", priority: "Medium" },
                        { task: "Generate monthly report", due: "2 days", priority: "Low" }
                      ].map((item, index) => (
                  ...
                  <Card className="shadow-elegant">
                    ...
                    <CardContent className="p-4 space-y-3">
                      {[
                        { task: "Course content audit", progress: "75%", assignee: "John Doe" },
                        { task: "User feedback analysis", progress: "40%", assignee: "Jane Smith" }
                      ].map((item, index) => (
                        <div key={index} className="p-3 bg-white border rounded-lg">
                          <p className="font-medium text-sm">{item.task}</p>
                          <p className="text-xs text-muted-foreground mt-1">Assignee: {item.assignee}</p>
                          <div className="mt-2">
                  ...
                  <Card className="shadow-elegant">
                    ...
                    <CardContent className="p-4 space-y-3">
                      {[
                        { task: "Monthly backup verification", completed: "Yesterday" },
                        { task: "Security audit", completed: "2 days ago" },
                        { task: "Database optimization", completed: "1 week ago" }
                      ].map((item, index) => (
                        <div key={index} className="p-3 bg-white border rounded-lg">
                          <p className="font-medium text-sm">{item.task}</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage new user onboarding process</p>
                  </div>
                  <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700">
                    <Plus className="w-4 h-4 mr-2" />
                    Add Step
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="shadow-elegant">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {[
                          { step: "Account Setup", completion: 92, users: 1645 },
                          { step: "Profile Completion", completion: 78, users: 1384 },
                          { step: "First Course Enrollment", completion: 65, users: 1161 },
                          { step: "First Assessment", completion: 43, users: 768 }
                        ].map((item, index) => (
                          <div key={index} className="space-y-2">
                            <div className="flex justify-between text-sm">
                              <span className="font-medium">{item.step}</span>
                              <span className="text-muted-foreground">{formatPercentage(item.completion)} ({item.users} users)</span>
                            </div>
                            <div className="w-full bg-gray-200 rounded-full h-2">
                              <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full" style={{width: `${item.completion}%`}}></div>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  <Card className="shadow-elegant">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {[
                          { name: "Alice Cooper", email: "alice@example.com", joined: "2 hours ago", status: "Active" },
                          { name: "Bob Wilson", email: "bob@example.com", joined: "5 hours ago", status: "In Progress" },
                          { name: "Carol Brown", email: "carol@example.com", joined: "1 day ago", status: "Completed" },
                          { name: "David Lee", email: "david@example.com", joined: "2 days ago", status: "Pending" }
                        ].map((user, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div>
                            ...
                            <Badge variant={user.status === "Completed" ? "default" : user.status === "Active" ? "secondary" : "outline"}>
                              {user.status}
                            </Badge>
                          </div>
                        ))}
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage your administrative team</p>
                  </div>
                  <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700">
                    <Plus className="w-4 h-4 mr-2" />
                    Add Member
                ...
                <Card className="shadow-elegant">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { name: "John Administrator", role: "Super Admin", email: "john@admin.com", status: "Online", lastActive: "Now", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face&auto=format" },
                        { name: "Sarah Manager", role: "Content Manager", email: "sarah@admin.com", status: "Online", lastActive: "5m ago", avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=40&h=40&fit=crop&crop=face&auto=format" },
                        { name: "Mike Moderator", role: "Moderator", email: "mike@admin.com", status: "Away", lastActive: "1h ago", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face&auto=format" },
                        { name: "Lisa Support", role: "Support", email: "lisa@admin.com", status: "Offline", lastActive: "2h ago", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop&crop=face&auto=format" }
                      ].map((member, index) => (
                        <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-white to-gray-50 rounded-xl border border-gray-200">
                          <div className="flex items-center gap-4">
                            <div className="relative">
                              <img
                                src={member.avatar}
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">Detailed analytics and course performance metrics</p>
                  </div>
                  <Button 
                    variant="outline" 
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-3xl font-bold text-green-600">{formatPercentage(87)}</p>
                        </div>
                        <TrendingUp className="w-8 h-8 text-green-500" />
                      </div>
                      <div className="mt-4">
                        <Badge className="bg-green-100 text-green-700">+5% from last month</Badge>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <Card className="shadow-elegant">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { name: "React Advanced Patterns", students: 1247, completion: 92, rating: 4.9, revenue: formatPHP(698320) },
                        { name: "JavaScript Fundamentals", students: 2156, completion: 89, rating: 4.8, revenue: formatPHP(1207360) },
                        { name: "UI/UX Design Principles", students: 987, completion: 85, rating: 4.7, revenue: formatPHP(552720) },
                        { name: "Node.js Backend Development", students: 1543, completion: 88, rating: 4.8, revenue: formatPHP(864080) },
                        { name: "Python for Beginners", students: 1876, completion: 91, rating: 4.9, revenue: formatPHP(1050560) }
                      ].map((course, index) => (
                        <div key={index} className="grid grid-cols-6 gap-4 p-4 bg-gradient-to-r from-white to-gray-50 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200">
                          <div className="col-span-2">
                            <h4 className="font-semibold">{course.name}</h4>
                            <p className="text-sm text-muted-foreground">{course.students} students enrolled</p>
                          </div>
                          <div className="text-center">
                            <p className="font-semibold text-green-600">{formatPercentage(course.completion)}</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-orange-600">
                            {formatPHP(users.length > 0 ? users.reduce((sum, u) => sum + (u.totalSpent || 0), 0) / users.length : 0)}
                          </p>
                        </div>
