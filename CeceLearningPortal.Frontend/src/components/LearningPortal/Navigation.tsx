  ...
  const getNavItems = () => {
    if (!isAuthenticated) {
      return [
        ...
        { label: "Hub", icon: Globe2, href: "/hub" },
    ...
    switch (user?.role) {
      case "Learner":
        return [
          ...
          { label: "Marketplace", icon: BookOpen, href: "/marketplace" },
          { label: "Hub", icon: Globe2, href: "/hub" },
          { label: "Affiliate", icon: Share2, href: "/affiliate" },
          { label: "Pricing", icon: Crown, href: "/pricing" },
              ...
              <div className="flex items-center gap-4">
                ...
                {canSwitchRoles && (
                  <div className="flex items-center gap-3">
                    ...
                    <Select
                      value={user?.role}
                      onValueChange={(value) =>
                        handleRoleSwitch(value as UserRole)
                      }
                    >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="relative h-8 w-8 rounded-full p-0 hover:ring-2 hover:ring-primary hover:ring-offset-2 transition-all"
                    >
