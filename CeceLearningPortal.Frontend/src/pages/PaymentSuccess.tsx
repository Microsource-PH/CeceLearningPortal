            ...
            <Card className="text-center">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  We couldn't verify your payment. If you've been charged,
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="text-center shadow-card">
            <CardHeader>
              ...
              <CardTitle className="text-2xl text-learning-success">
                Payment Successful!
              </CardTitle>
            </CardHeader>
                ...
                <div className="bg-gradient-card p-4 rounded-lg space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">
                      {formatPHP(paymentDetails.amount)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="flex flex-col items-center p-3 bg-gradient-card rounded-lg">
                    ...
                    <span className="text-muted-foreground text-center">
                      Get course materials and exercises
                    </span>
                  </div>
                  <div className="flex flex-col items-center p-3 bg-gradient-card rounded-lg">
                    ...
                    <span className="text-muted-foreground text-center">
                      Complete the course for certification
                    </span>
                  </div>
                </div>
              </div>
